...
from bair.llm_explainer import load_llm_model, generate_with_hf, generate_geochat_skysense_intervention
...
try:
    from experiments.gender_analysis import (
...
def extract_gt_only_context(context: str) -> str:
    ...
    Same contract as iuchest_analysis.extract_gt_only_context for NIH.
    """
...
def main() -> None:
    ...
    parser.add_argument("--dataset-json", type=str, default=str(repo_root / "data" / "generated" / "nwpu_retrieval_dataset.json"))
    parser.add_argument("--model-name", type=str, required=True)
    parser.add_argument("--device-id", type=int, default=0)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--num-samples", type=int, default=0)
    parser.add_argument("--max-new-tokens", type=int, default=64)
    parser.add_argument("--output-dir", type=str, default=str(repo_root / "outputs" / "generation_results_nwpu"))
    parser.add_argument(
        "--context-mode",
        type=str,
        default="full",
