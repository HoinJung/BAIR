...
from bottleneck_intervention import NWPURAGInterventionManager
...
def main() -> None:
    ...
    parser.add_argument("--nwpu-test-root", type=str, default=str(base_dir / "data" / "raw" / "NWPU" / "test" / "test"))
    parser.add_argument("--schema-json", type=str, default=str(base_dir / "data" / "metadata" / "nwpu_label_schema.json"))
    parser.add_argument("--database-fixed-json", type=str, default=str(base_dir / "data" / "metadata" / "nwpu_database_fixed.json"))
    parser.add_argument("--output-json", type=str, default=str(base_dir / "data" / "generated" / "nwpu_retrieval_dataset.json"))
