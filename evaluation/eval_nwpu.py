...
def main() -> None:
    ...
    parser.add_argument("--keyword-json", type=str, default=str(repo_root / "data" / "metadata" / "nwpu_keyword_matching.json"))
    parser.add_argument(
        "--baseline-json",
        type=str,
        default=None,
    ...
    parser.add_argument(
        "--exclude-json",
        type=str,
        default=str(repo_root / "data" / "metadata" / "nwpu_exclude.json"),
